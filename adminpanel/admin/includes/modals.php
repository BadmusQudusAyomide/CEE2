...
<div class="modal fade" id="modalForAddSchool" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="updateSchoolFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>School</label>
            <input type="" name="schoolName" id="school_name" class="form-control" placeholder="Input School" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-footer">
...
<!-- Modal For Update School -->
<div class="modal fade myModal" id="updateSchool-<?php echo $selSchoolRow['cou_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="addSchoolFrm" method="post" >
       <div class="modal-content myModal-content" >
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update ( <?php echo $selSchoolRow['cou_name']; ?> )</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              <label>School</label>
              <input type="" name="school_name" id="school_name" class="form-control" value="<?php echo $selSchoolRow['cou_name']; ?>">
            </div>
          </div>
        </div>
        <div class="modal-footer">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="School" id="School">
             ...
             <option value="URBAN DAY GRAMMAR SCHOOL SENIOR">URBAN DAY GRAMMAR SCHOOL SENIOR</option>
             <option value="URBAN DAY GRAMMAR SCHOOL JUNIOR">URBAN DAY GRAMMAR SCHOOL JUNIOR</option>
             <option value="COMMUNITY HIGH SCHOOL ALARERE">COMMUNITY HIGH SCHOOL ALARERE</option>
             <option value="ADEGBAI COMMUNITY HIGH SCHOOL">ADEGBAI COMMUNITY HIGH SCHOOL</option>
             <option  value="CHRIST ANGLICAN SECONDARY SCHOOL">CHRIST ANGLICAN SECONDARY SCHOOL</option>
             <option value="QUEST ACADEMY">QUEST ACADEMY</option>
