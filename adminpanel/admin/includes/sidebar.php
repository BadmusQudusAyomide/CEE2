                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">MANAGE SCHOOL</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         School
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" data-toggle="modal" data-target="#modalForAddSchool">
                                                <i class="metismenu-icon"></i>
                                                Add School
                                            </a>
                                        </li>
                                        <li>
                                            <a href="home.php?page=manage-school">
                                                <i class="metismenu-icon">
                                                </i>Manage School
                                            </a>
                                        </li>
                                ...
                                <li class="app-sidebar__heading">Result Checking</li>
                                <li>
                                    <a href="C:\Users\Ayomide\Desktop\BADMUS QUDUS AYOMIDE\Student Result Management System Using PHP">
                                        <i class="metismenu-icon pe-7s-chat">
                                        </i>All Result
                                    </a>
                                </li>
